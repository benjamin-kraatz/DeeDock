...
Those browse controls live in the search field. **Ask Robi** appears there for a nonempty query
and uses on-device Apple Intelligence to suggest apps for a task you describe.
