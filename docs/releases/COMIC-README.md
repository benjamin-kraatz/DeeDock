...
Current authored comic: [0.6.0-comic.md](0.6.0-comic.md) and [0.6.0-comic.html](0.6.0-comic.html), with notes in [0.6.0.md](0.6.0.md). The 0.5.0 Focus, Compost, and Gossip comic stays on that version.
