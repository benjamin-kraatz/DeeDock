...
private final class DocumentFixtureService: ApplicationServicing {
    ...
    func performPrimaryAction(_ reference: ApplicationReference) async throws -> ApplicationPrimaryActionOutcome { try await request(reference, urls: nil); return .opened }
